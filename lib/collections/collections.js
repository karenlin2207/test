...
if (Meteor.isServer) {
  console.log("[test publish setRoles]");
  // This code only runs on the server
  Meteor.publish('setRoles', function(roleId) {
    console.log("[pub][setRoles]", setRoles.find(_id:roleId));
    return setRoles.find({_id:roleId});
  });
}
